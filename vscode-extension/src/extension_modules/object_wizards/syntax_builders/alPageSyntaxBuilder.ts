...
export class ALPageSyntaxBuilder {
    ...
    buildFromPageWizardData(destUri: vscode.Uri | undefined, data : ALPageWizardData, projectProfile: LSPIProjectProfile | undefined) : string {
        ...
        if ((!pageAppAreaAdded) && (data.applicationArea) && (data.applicationArea !== "") && (data.applicationAreaMode === ALAppAreaMode.inheritFromMainObject)) {
            writer.addProperty("ApplicationArea", data.applicationArea);
            pageAppAreaAdded = true;
        }
