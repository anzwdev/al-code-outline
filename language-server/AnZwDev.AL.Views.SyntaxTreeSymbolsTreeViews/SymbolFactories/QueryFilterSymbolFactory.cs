...
{
    internal static class QueryFilterSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(QueryFilterSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Name, 
                ALSyntaxNodeKind.QueryFilter,
