...
{
    internal static class PageActionAreaSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(PageActionAreaSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Name, 
                ALSyntaxNodeKind.PageActionArea, 
