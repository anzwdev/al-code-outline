...
{
    internal static class PageLayoutSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(PageLayoutSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, null, 
                ALSyntaxNodeKind.PageLayout,
