...
{
    internal static class PageSystemActionSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(PageSystemActionSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Name, 
                ALSyntaxNodeKind.PageSystemAction,
