...
{
    internal static class PageActionSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(PageActionSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Name, 
                ALSyntaxNodeKind.PageAction,
