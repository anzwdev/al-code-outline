...
{
    internal static class ViewAddChangeSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(ViewAddChangeSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Anchor, 
                ALSyntaxNodeKind.ViewAddChange, 
