...
{
    internal static class PageViewSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(PageViewSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Name, 
                ALSyntaxNodeKind.PageView,
