...
{
    internal static class KeyListSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(KeyListSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, null, 
                ALSyntaxNodeKind.KeyList, 
