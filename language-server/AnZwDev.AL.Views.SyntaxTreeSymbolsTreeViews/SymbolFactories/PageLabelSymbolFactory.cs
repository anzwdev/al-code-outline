...
{
    internal static class PageLabelSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(PageLabelSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Name, 
                ALSyntaxNodeKind.PageLabel,
