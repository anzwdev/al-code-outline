...
{
    internal static class ControlAddChangeSymbolFactory
    {
        public static SyntaxTreeSymbolsTreeViewNode CreateSymbol(ControlAddChangeSyntax node, SyntaxTreeSymbolsTreeViewNode? parentNode)
        {
            return SyntaxNodeSymbolFactory.CreateSymbol(
                node, node.Anchor, 
                ALSyntaxNodeKind.ControlAddChange,
