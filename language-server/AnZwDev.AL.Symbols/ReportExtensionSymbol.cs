...
namespace AnZwDev.AL.Symbols
{
    ...
    public class ReportExtensionSymbol : ObjectExtensionWithCodeSymbol
    {

        public required RequestPageExtensionSymbol? RequestPage { get; init; }
        ...
        public ReportExtensionSymbol(int id, FullyQualifiedName fullyQualifiedName, PropertySymbolsCollection properties)
        ...
        {
            return ObjectKind.ReportExtension;
        }
