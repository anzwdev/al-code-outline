...
{
    public static class SyntaxNodeListExtensions
    {
        ...
        public static bool SortWithTrivia<T>(this List<SyntaxNodeSortInfo<T>> list, IComparer<SyntaxNodeSortInfo<T>> comparer) where T : SyntaxNode
        {
            ...
            IList<T> syntaxNodeList = new SyntaxNodeSortInfoSyntaxNodesList<T>(list);
        ...
        private static void SortWithTriviaMoveTrivia<T>(IList<T> list, out bool listHasLeadingNewLine, out bool listHasTrailingNewLine, out SyntaxTrivia listLeadingTrivia) where T : SyntaxNode
        {
            ...
            listHasLeadingNewLine = ((leadingTrivias.Count > 0) && (leadingTrivias[0].Kind == SyntaxKind.EndOfLineTrivia));
            ...
            listHasTrailingNewLine = ((trailingTrivias.Count > 0) && (trailingTrivias[trailingTrivias.Count - 1].Kind == SyntaxKind.EndOfLineTrivia));
            ...
            for (int i = 0; i < (list.Count - 1); i++)
            {
                ...
                bool trailingNewLine = ((trailingTrivias.Count > 0) && (trailingTrivias[trailingTrivias.Count - 1].Kind == SyntaxKind.EndOfLineTrivia));
                bool leadingNewLine = ((leadingTrivias.Count > 0) && (leadingTrivias[0].Kind == SyntaxKind.EndOfLineTrivia));
        ...
        private static void SortWithTriviaRestoreTrivia<T>(IList<T> list, bool listHasLeadingNewLine, bool listHasTrailingNewLine, SyntaxTrivia listLeadingTrivia) where T : SyntaxNode
        {
            ...
            {
                SyntaxTriviaList trailingTrivias = list[list.Count - 1].GetTrailingTrivia();
                if ((trailingTrivias.Count > 0) && (trailingTrivias[trailingTrivias.Count - 1].Kind == SyntaxKind.EndOfLineTrivia))
                {
