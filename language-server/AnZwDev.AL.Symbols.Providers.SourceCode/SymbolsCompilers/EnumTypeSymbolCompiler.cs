...
{
    internal static class EnumTypeSymbolCompiler
    {

        public static EnumTypeSymbol Compile(EnumTypeSyntax syntax, string? namespaceName, HashSet<string>? usings, string sourceFileName)
        {
            ...
            return new EnumTypeSymbol(id, new FullyQualifiedName(namespaceName, name), properties)
            {
