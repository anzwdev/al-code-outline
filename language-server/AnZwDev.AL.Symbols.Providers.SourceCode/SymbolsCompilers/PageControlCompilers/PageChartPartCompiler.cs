...
{
    internal static class PageChartPartCompiler
    {

        public static PageControlSymbol? Compile(PageChartPartSyntax syntax, HashSet<string>? usings)
        {
            if (syntax == null)
                return null;
            ...
            return new PageControlSymbol()
            {
                ...
                Kind = PageControlKind.ChartPart,
                Properties = PropertySymbolCompiler.Compile(syntax.PropertyList),
                RelatedPagePartId = ObjectReferenceCompiler.Compile(ObjectKind.Chart, usings, syntax.ChartPartType),
                Controls = null,
                Actions = null,
