...
{
    public static class PermissionSetSymbolCompiler
    {

        public static PermissionSetSymbol Compile(PermissionSetSyntax syntax, string? namespaceName, HashSet<string>? usings, string sourceFileName)
        {
            ...
            return new PermissionSetSymbol(id, new FullyQualifiedName(namespaceName, name), properties)
            {
