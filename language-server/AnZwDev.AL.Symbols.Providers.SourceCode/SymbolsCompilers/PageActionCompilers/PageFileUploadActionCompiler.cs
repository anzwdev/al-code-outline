...
{
    internal static class PageFileUploadActionCompiler
    {

        public static PageActionSymbol? Compile(PageFileUploadActionSyntax syntax)
        {
            if (syntax == null)
                return null;
            ...
            return new PageActionSymbol()
            {
                ...
                Kind = PageActionKind.FileUploadAction,
